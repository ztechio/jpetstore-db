...
INSERT INTO product VALUES ('FI-FW-02','FISH', 'Clown Fish','<image src="../images/fish2.gif">Salt Water fish from Austra;lia');
INSERT INTO product VALUES ('K9-BD-01','DOGS','Pit Bull','<image src="../images/dog1.gif">Friendly dog from England');
INSERT INTO product VALUES ('K9-PO-02','DOGS','Terrier','<image src="../images/dog6.gif">Cute dog from France');
INSERT INTO product VALUES ('K9-DL-01','DOGS', 'German Shepherd','<image src="../images/dog3.gif">Great dog from Germany');
...
NSERT INTO  item (itemid, productid, listprice, unitcost, supplier, status, attr1) VALUES('EST-1','FI-SW-01',16.50,10.00,1,'P','Large');
...
INSERT INTO  item (itemid, productid, listprice, unitcost, supplier, status, attr1) VALUES('EST-9','K9-DL-01',18.50,12.00,1,'P','Adult Male');
INSERT INTO  item (itemid, productid, listprice, unitcost, supplier, status, attr1) VALUES('EST-10','K9-DL-01',18.50,12.00,1,'P','Adult Female');
...
INSERT INTO  item (itemid, productid, listprice, unitcost, supplier, status, attr1) VALUES('EST-22','K9-RT-02',135.50, 100.00,1,'P','Male Puppy');
INSERT INTO  item (itemid, productid, listprice, unitcost, supplier, status, attr1) VALUES('EST-23','K9-RT-02',145.49, 100.00,1,'P','Female Puppy');
